...
router.param('mockTestId', checkValidId);
...
router.get('/:id', mockTestController.getMockTest); // Regex removed, handled by middleware!
...
router.get('/attempts/:id', mockTestController.getAttemptDetails); // Regex removed
