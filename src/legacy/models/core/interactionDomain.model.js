...
// ==========================================
// DISCUSSION SCHEMA (Updated with Virtuals)
// ==========================================
const discussionSchema = new mongoose.Schema({
  ...
  timestamps: true,
  // ✅ REQUIRED: Tells Mongoose to include virtuals when converting to JSON/Objects
  toJSON: { virtuals: true },
  toObject: { virtuals: true }
});

// ✅ REQUIRED: The Virtual populate definition that links Discussions to Replies
discussionSchema.virtual('replies', {
  ref: 'DiscussionReply',     // The model we are connecting to
  foreignField: 'discussion', // The field in DiscussionReply that holds the discussion ID
  localField: '_id'           // The local field in this schema to match against
});
