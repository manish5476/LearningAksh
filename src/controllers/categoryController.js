...
const CategoryRepository = require('../repositories/CategoryRepository'); // For simple factory gets
...
exports.getCategoryWithCourses = catchAsync(async (req, res, next) => {
  const data = await CategoryService.getCategoryWithCourses(req.params.id);
  res.status(200).json({ 
    status: 'success', 
...
// ==========================================
// Instead of the old factory, we just use the Repository methods

exports.getAllCategories = catchAsync(async (req, res, next) => {
  const result = await CategoryRepository.findMany(req.query);
  res.status(200).json({ 
    status: 'success', 
