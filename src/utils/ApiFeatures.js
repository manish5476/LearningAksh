    ...
    for (const key in queryObj) {
      ...
      if (typeof value === "object") {
        ...
        for (const op in value) {
          ...
          mongoFilter[key][mongoOperator] = ApiFeatures.coerceValue(value[op]);
        }
        continue;
      }
...
//     // ✅ FIXED: We now use this.query.getFilter() to include the 
//     // isPublished and isDeleted checks in our total count!
//     const totalResults = await Model.countDocuments(this.query.getFilter());
