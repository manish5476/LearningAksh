...
// ============================================
// Trust only the 1st proxy hop (Fixes express-rate-limit IP spoofing)
...
const corsOptions = {
  origin: function (origin, callback) {
    // Note: You are currently allowing all origins. Update this for strict production security later!
    callback(null, true);
  },
  credentials: true,
...
// ============================================
// PARSERS (Cookies, UserAgent, File Uploads)
// ============================================
app.use(useragent.express());
app.use(cookieParser(process.env.COOKIE_SECRET));

app.use(fileUpload({
  limits: { fileSize: 50 * 1024 * 1024 }, // Files get 50MB max
  useTempFiles: true,
  tempFileDir: '/tmp/',
...
app.use('/admin/queues', protect, restrictTo('admin'), queueMonitor.getRouter());
...
// const queueMonitor = require('./jobs/queueMonitor');
// const { protect, restrictTo } = require('./middlewares/authMiddleware');
// // const { auditLog } = require('./middlewares/auditMiddleware'); // Assuming this might be used later
...
//       callback(null, true);
//     } else {
//       callback(null, true); // Still allowing all for now based on your logic
//     }
//   },
//   credentials: true,
//   optionsSuccessStatus: 200,
...
// app.use(cors(corsOptions)); // Removed the duplicate declaration here
